...
```powershell
Invoke-WebRequest -Uri https://github.com/RichardSlater/AtomicGiftLinkGenerator/releases/download/v0.2.17/AtomicGiftLinkGenerator_0.2.17-win-x64.zip -OutFile AtomicGiftLinkGenerator_0.2.17-win-x64.zip
Expand-Archive ./AtomicGiftLinkGenerator_0.2.17-win-x64.zip
...
wget https://github.com/RichardSlater/AtomicGiftLinkGenerator/releases/download/v0.2.17/AtomicGiftLinkGenerator_0.2.17-linux-x64.tar.gz
tar -xvzf ./AtomicGiftLinkGenerator_0.2.17-linux-x64.tar.gz
k
./giftlinkgen generate
```
