...
```powershell
Invoke-WebRequest -Uri https://github.com/RichardSlater/AtomicGiftLinkGenerator/releases/download/v0.2.23/AtomicGiftLinkGenerator_0.2.23-win-x64.zip -OutFile AtomicGiftLinkGenerator_0.2.23-win-x64.zip
Expand-Archive ./AtomicGiftLinkGenerator_0.2.23-win-x64.zip
cd ./AtomicGiftLinkGenerator_0.2.23-win-x64
