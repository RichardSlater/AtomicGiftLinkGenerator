...
```powershell
Invoke-WebRequest -Uri https://github.com/RichardSlater/AtomicGiftLinkGenerator/releases/download/v0.2.13/AtomicGiftLinkGenerator_0.2.13-win-x64.zip -OutFile AtomicGiftLinkGenerator_0.2.13-win-x64.zip
Expand-Archive ./AtomicGiftLinkGenerator_0.2.13-win-x64.zip
cd ./AtomicGiftLinkGenerator_0.2.13-win-x64
...
wget https://github.com/RichardSlater/AtomicGiftLinkGenerator/releases/download/v0.2.13/AtomicGiftLinkGenerator_0.2.13-linux-x64.tar.gz
tar -xvzf ./AtomicGiftLinkGenerator_0.2.13-linux-x64.tar.gz
k
./giftlinkgen generate
```
